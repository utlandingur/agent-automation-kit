...
- For new UI, prioritize your project's established design patterns.
...
- Prefer one-focus-per-screen flows for high-attention tasks.
...
- Pattern maps to project design guidance (or documented adaptation)
